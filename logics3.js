...
function slideDown(){
	for(let c=0; c<columns; c++){
        ...
        let changedIndices = []; // This variable and the loop will record the position of the tiles
...
// This will listen to when we touch the screen and assigns the x coordinator of that touch
